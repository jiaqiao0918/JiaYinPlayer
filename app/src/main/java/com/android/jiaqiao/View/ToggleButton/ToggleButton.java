package com.android.jiaqiao.View.ToggleButton;
...
public class ToggleButton extends View{
	...
	/** 关闭颜色*/
	private int offBorderColor = Color.parseColor("#dadbda");//关闭颜色
	/** 灰色带颜色*/
	private int offColor = Color.parseColor("#ffffff");//滑块旁边颜色
	/** 手柄颜色*/
	private int spotColor = Color.parseColor("#ffffff");//滑块颜色
	/** 边框颜色*/
	private int borderColor = offBorderColor;//边框颜色
	/** 画笔*/
	private Paint paint ;
	/** 开关状态*/
	...
	public void setToggle(boolean is_not) {
		if(is_not){
			toggleOn();
		}else{
			toggleOff();
