...
public class MusicPlayRecyclerViewAdapter extends RecyclerView.Adapter<MusicPlayRecyclerViewAdapter.ViewHolder> {
	private ArrayList<MusicInfo> list = new ArrayList<MusicInfo>();

	private OnRecyclerViewItemClickListener mOnItemClickListener = null;
	private OnRecyclerItemLongListener mOnItemLong = null;

	public MusicPlayRecyclerViewAdapter(ArrayList<MusicInfo> list) {
		super();
		this.list = list;
	}
	...
	public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
		View view = LayoutInflater.from(viewGroup.getContext()).inflate(
				R.layout.show_music_play_list, viewGroup, false);
